...
public class RegistrarProdutosPainelJFrame extends javax.swing.JFrame {
    public RegistrarProdutosPainelJFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/18188249.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ComboxCategoria, 0, 274, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarProdutosPainelJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarProdutosPainelJFrame().setVisible(true);
            }
        });
    }
    ...
    public void CadastrarProduto(){
        ...
        status = (String) ComboxCategoria.getSelectedItem();
        qtdMl = Integer.parseInt(txtCapacidade.getText());
        preco = Float.parseFloat(txtPreco.getText());
        
        ProdutoDTO objprodutodto = new ProdutoDTO();
        objprodutodto.setNome_produto(nome);
        objprodutodto.setGalao_status(status);
        objprodutodto.setCapacidade_produto(qtdMl);
        objprodutodto.setPreco_galao(preco);
